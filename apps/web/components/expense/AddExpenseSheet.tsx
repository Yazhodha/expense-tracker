...
export function AddExpenseSheet({ categories, onAdd, onAddCategory, currency = 'Rs.' }: AddExpenseSheetProps) {
  ...
  const regularCategories = categories.filter(cat => cat.id !== 'other');
        ...
        >
            ...
            <div>
              ...
              <div className="grid grid-cols-5 gap-3">
                ...
                {/* Other/Add Custom Category button */}
                {otherCategory && (
                  <motion.button
                    whileTap={{ scale: 0.95 }}
                    onClick={() => {
                    ...
                    className={`flex flex-col items-center gap-1 p-3 rounded-xl transition-colors ${
                      selectedCategory === otherCategory.id && !onAddCategory
                  ...
                  >
                    ...
                    <span className="text-xs truncate w-full text-center">
                      {onAddCategory ? 'Add New' : otherCategory.name}
                    </span>
                  </motion.button>
                )}
              </div>
